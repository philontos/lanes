...
# Note: the superpowers skills are baked into the Docker image at build time
# (Dockerfile clones obra/superpowers), so there is no host plugin to install here.
